...
public class CatalogueModel extends Observable
{
   ...
   * @return A list of procucts
   */
  public List<Product> getAllProducts() throws StockException {
      return theStock.getAllProducts();
  }
...
//    int amount = 1;
//    try {
//      if (theStock.exists(pName)) {
//        Product pr = theStock.getDetails(pName);
...
//          theBasket.add(pr);
//          thePic = theStock.getImage(pName);
//        } else {
//          theAction =
//                  pr.getDescription() +
//                  " not in stock"; }
